...
Also `start` and `end` ignore hints from original [`v8-to-istanbul`](https://www.npmjs.com/package/v8-to-istanbul) are supported.
These ignore hints are checked from the original sources instead of transpiled code.

> * `/* v8 ignore start */`: start ignoring lines
> * `/* v8 ignore end */`: end ignoring lines
> * `<!-- /* v8 ignore start */ --!>`: start ignoring lines
> * `<!-- /* v8 ignore end */ --!>`: end ignoring lines
> * `anything /* v8 ignore start */ anything`: start ignoring lines
> * `anything /* v8 ignore end */ anything`: end ignoring lines
